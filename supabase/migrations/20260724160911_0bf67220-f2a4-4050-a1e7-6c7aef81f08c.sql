...
WITH CHECK (
  ...
  OR (
    ...
    AND (qualified IS NULL OR qualified = false)
...
-- 4) finalize_submission: qualified basato sul fatturato (>= 10k)
...
BEGIN
  ...
  v_qualified := (p_monthly_revenue IS NOT NULL AND p_monthly_revenue <> 'under-10k');
