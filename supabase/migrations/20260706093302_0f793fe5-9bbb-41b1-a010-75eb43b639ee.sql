...
DROP FUNCTION IF EXISTS public.update_partial_submission(uuid, text, integer, text, integer, jsonb, boolean, boolean, uuid);
...
REVOKE ALL ON FUNCTION public.update_partial_submission(text, text, integer, text, integer, jsonb, boolean, boolean, uuid) FROM public;
GRANT EXECUTE ON FUNCTION public.update_partial_submission(text, text, integer, text, integer, jsonb, boolean, boolean, uuid) TO anon, authenticated, service_role;
